...
(function () {
  ...
  function syncTabs() {
    ...
    var links = document.querySelectorAll("[data-slot='sidebar'] a[href^='#']");
    ...
    links.forEach(function (link) {
      ...
      if (label) {
        html += '<a class="cl-tab" href="' + hash + '">' + label + "</a>";
      }
    });
  ...
  function decorateConsole() {
    ...
    body.querySelectorAll("p").forEach(function (line) {
      ...
      line.style.display =
        consoleFilter === "all" || level === consoleFilter ? "" : "none";
    });
  ...
  function pinConsoles() {
    document.querySelectorAll("[data-console-scroll]").forEach(function (box) {
